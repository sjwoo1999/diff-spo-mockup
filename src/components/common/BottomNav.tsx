        ...
        <li>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
              className="w-5 h-5 sm:w-6 sm:h-6 mb-1">
              <path strokeLinecap="round" strokeLinejoin="round"
                d="M18 18.75a4.5 4.5 0 0 0-4.5-4.5m-3 0a4.5 4.5 0 0 0-4.5 4.5M18 18.75H6m12 0v.75a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3v-.75m9-12.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
            </svg>
            커뮤니티
          </button>
        </li>
        ...
        <li>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
              className="w-5 h-5 sm:w-6 sm:h-6 mb-1">
              <path strokeLinecap="round" strokeLinejoin="round"
                d="M16.5 9V6.75A4.5 4.5 0 0 0 12 2.25v0a4.5 4.5 0 0 0-4.5 4.5V9M4.5 9h15M4.5 9v10.5A2.25 2.25 0 0 0 6.75 21h10.5a2.25 2.25 0 0 0 2.25-2.25V9" />
            </svg>
            상점
          </button>
        </li>
